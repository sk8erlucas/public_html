<?php
	...
	$mail->FromName = 'Tansen Landing';
	$mail->AddAddress('ventas@tansen.com.ar');
	$mail->AddReplyTo($_POST['email']);
	$mail->Subject = 'Contacto Landing Tansen';
	...
	if($estadoEnvio){
		...
		$aResult['error'] = "Ocurrio un error al enviarnos la consulta. Por favor intenta nuevamente o escribinos directamente a: info@pluribol.com.ar";
	}
